...
if (isset($_POST['OK'])) {
  ...
  $sql = "insert into turma (nome, ano_ingresso, serie, Prof_idProf, curso) 
	values ('$nome','$ano_ingresso', '$serie','$Prof_idProf','$curso')";
...
-webkit-backdrop-filter: blur( 2px );
 ">
    ...
    font-size: 24px;
    color: #ffffff;
    font-family: none;">Criar Turma</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <div class="label-float">
                                <li class="list-group-item"><input class="form-control form-control-lg" type="text"
                                        placeholder=".form-control-lg" aria-label=".form-control-lg example" name="nome"
                                        id="nome" required>
                            ...
                            <div class="label-float">
                                <li class="list-group-item"><input class="form-control form-control-lg" type="text"
                                        ...
                                        name="ano_ingresso" id="ano_ingresso">
    ...
    -webkit-backdrop-filter: blur( 2px );">
                                <select class="form-select" aria-label="Default select example" name="curso"
                                    style="width: 94%; margin-left: 1em">
      ...
      ?>
            <div class="card" style="width: 18rem; color:black;">
                <div class="card-body">
                    <p><abbr title="Disponibilize Esse Codigo Para A Entrada Dos Alunos Na Sala De Aula">
                            Cod:
                            <?php
        echo $linha['idturma'];
            ?>
                    ...
                    <li class="list-group-item">
                        <div class="card-fotter">
                            <abbr title="Alunos Da Turma">
                                <a href="lista-aluno.php?idturma=<?= $linha['idturma'] ?>&disc=<?= $disc ?>"
                                    class="card-link"><i class="fa-solid fa-users fa-2x "></i> </a>
                            </abbr>
                            <abbr title="Registrar Presença">
                                <a href="COMPUTARPRESENCA.php?idturma=<?= $linha['idturma']?>" class="card-link"><i
                                        class="fa-regular fa-circle-check fa-2x  "></i></a>
                            </abbr>
                            <abbr title="Relatorios De Presença">
                                <a href="relatorioAluno.php?idturma=<?= $linha['idturma'] ?>&disc=<?= $disc ?>"
